...
//		}
	...
	Missile fire() {
		if(!live) return null;
		Missile m = new Missile(this.id, this.tank_x + TANK_W / 2 - Missile.MIS_W / 2, this.tank_y + TANK_H / 2 - Missile.MIS_H / 2,
	...
	Missile fire(Dir dir){
		if(!live) return null;
		return new Missile(this.id, this.tank_x + TANK_W / 2 - Missile.MIS_W / 2, this.tank_y + TANK_H / 2 - Missile.MIS_H / 2,
...
//				break;
	...
	void locateDir() {
		...
		if(dir != oldDir){
			TankMoveMsg msg = new TankMoveMsg(id, dir, eject_dir, this);
			tc.nc.send(msg);
		}
	}
	...
	public Dir getEject_dir() {
		return eject_dir;
	}

	public void setEject_dir(Dir eject_dir) {
