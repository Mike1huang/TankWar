...
public class Missile {
	...
	public Missile(int tankId, int mis_x, int mis_y, Dir dir) {
		this.tankId = tankId;
		this.mis_x = mis_x;
		this.mis_y = mis_y;
		this.dir = dir;
	...
	public Missile(int tankId, int mis_x, int mis_y, boolean good, Dir dir, TankClient tc) {
		this(tankId, mis_x, mis_y, dir);
		this.isGood = good;
		this.tc = tc;
	}
	...
	public void setMis_x(int mis_x) {
		this.mis_x = mis_x;
	}
	...
	public void setMis_y(int mis_y) {
		this.mis_y = mis_y;
	}
